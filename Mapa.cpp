...
void Mapa::loadMap(Player * player, Collision * collision, Background * background, GameItems * gameItems){
	...
	// LOADING GAMEITEMS //////////////////////////////////////////////////////////////////////////////////
	this->obiekty[5].load(5, "bohater.bmp", -500, 0, 0, 3, true, "jotpe", false);
	this->obiekty[6].load(6, "bohater1.bmp", -200, -100, 0, 3, true, "jotpe", false);
	this->obiekty[7].load(7, "bohater2.bmp", -200, -200, 0, 3, true, "halu_sztefi", false);
	this->obiekty[8].load(8, "bohater3.bmp", 40, 100, 0, 3, true, "halu_sztefi", false);
	this->obiekty[9].load(9, "bohater4.bmp", 200, -30, 0, 3, true, "gudbaj_sztefi", false);
	this->obiekty[10].load(10, "bohater5.bmp", 140, 100, 0, 3, true, "gudbaj_sztefi", false);

	this->obiekty[11].load(11, "budynek.bmp", -400, -1000, 0, 3, false, "", false);
	this->obiekty[12].load(12, "budynek1.bmp", 40, -1400, 0, 3, false, "", false);
	this->obiekty[13].load(13, "budynek2.bmp", 400, -1800, 0, 3, false, "", false);
	this->obiekty[14].load(14, "budynek3.bmp", 200, 20, -800, 3, false, "", false);
	this->obiekty[15].load(15, "budynek4.bmp", -400, -600, 0, 3, false, "", false);
	this->obiekty[16].load(16, "budynek5.bmp", 800, -1000, 0, 3, false, "", false);

	this->obiekty[17].load(17, "latarnia.bmp", 100, -2000, 0, 3, false, "", false);
	this->obiekty[18].load(18, "latarnia.bmp", 100, -2300, 0, 3, false, "", false);
	this->obiekty[19].load(19, "latarnia.bmp", 100, -2600, 0, 3, false, "", false);
	this->obiekty[20].load(20, "latarnia.bmp", 100, -2900, 0, 3, false, "", false);
	this->obiekty[21].load(21, "latarnia.bmp", 100, -3200, 0, 3, false, "", false);
	this->obiekty[22].load(22, "latarnia.bmp", 100, -3500, 0, 3, false, "", false);
	this->obiekty[23].load(23, "latarnia.bmp", 100, -3800, 0, 3, false, "", false);
	this->obiekty[24].load(24, "latarnia.bmp", 100, -4100, 0, 3, false, "", false);
	this->obiekty[25].load(25, "latarnia.bmp", 100, -4400, 0, 3, false, "", false);
	this->obiekty[26].load(26, "latarnia.bmp", 100, -4700, 0, 3, false, "", false);
	this->obiekty[27].load(27, "latarnia.bmp", -100, -4800, 0, 3, false, "", false);
	this->obiekty[28].load(28, "latarnia.bmp", -200, -5000, 0, 3, false, "", false);
	this->obiekty[29].load(29, "latarnia.bmp", -400, -5200, 0, 3, false, "", false);
	this->obiekty[30].load(30, "latarnia.bmp", -700, -5300, 0, 3, false, "", false);
	this->obiekty[31].load(31, "latarnia.bmp", -900, -5400, 0, 3, false, "", false);
	this->obiekty[32].load(32, "latarnia.bmp", -1200, -5400, 0, 3, false, "", false);
	this->obiekty[33].load(33, "latarnia.bmp", -1500, -5400, 0, 3, false, "", false);
	this->obiekty[34].load(34, "latarnia.bmp", -1800, -5400, 0, 3, false, "", false);
	this->obiekty[35].load(35, "latarnia.bmp", -2100, -5400, 0, 3, false, "", false);
	this->obiekty[36].load(36, "latarnia.bmp", -2400, -5400, 0, 3, false, "", false);
	this->obiekty[37].load(37, "latarnia.bmp", -2700, -5400, 0, 3, false, "", false);
